...
TEST_F(DebrisDetectorTest, DetectsDebrisInImage) {
  ...
  auto test_image_left = createTestImageWithDebrisAtPosition(100, 100);  // Debris placed at (100,100)
  ...
  auto test_image_right = createTestImageWithDebrisAtPosition(250, 100);  // Debris placed at (250,100)
  ...
  // Test case 3: Center_x between 180 and 200, area <= 40000, triggers move_forward_
  auto test_image_center = createTestImageWithDebrisAtPosition(140, 100);  // Debris placed at (190,100)
...
TEST_F(DebrisDetectorTest, NavigateToDebrisTest) {
  ...
  debris_detector_->set_velocity_publisher(
    debris_detector_->create_publisher<geometry_msgs::msg::Twist>("cmd_vel", 10));
